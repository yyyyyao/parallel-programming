...
int main(int argc, char* argv[])
{
  ...
  cout << "Execution time:" << (float)(time_end - time_start) / 1000000
      << "[msec]" << endl;
  ...
  for(int i = 0; i < 70; i++) {
    cout << (int)output_cl.data[i] << endl;
    cout << (float)f_[i] << endl;
  }
