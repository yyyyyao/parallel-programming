...
int main(int arg_c, char* ppArgs[])
{
  ...
  params.m_two_pass_flag = optimize_huffman_tables; /* if optimize_huffman_tables is true, this code will generates optimize huffman tables, if false, use predefined huffman tables. */
